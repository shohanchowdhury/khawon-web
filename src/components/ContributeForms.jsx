...
import FoodPhotoPicker from './FoodPhotoPicker'
import RestaurantPhotoPicker from './RestaurantPhotoPicker'

export default function ContributeForms({ foodTypes, onFoodCreated, onRestaurantCreated }) {
